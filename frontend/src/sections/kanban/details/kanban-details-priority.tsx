    ...
    <Stack direction="row" flexWrap="wrap" spacing={1}>
      {['Low', 'Medium', 'High'].map((option) => (
        ...
        >
          <Iconify
            icon={
              (option.toLowerCase() === 'low' && 'solar:double-alt-arrow-down-bold-duotone') ||
              (option.toLowerCase() === 'medium' && 'solar:double-alt-arrow-right-bold-duotone') ||
              'solar:double-alt-arrow-up-bold-duotone'
            }
            sx={{
              mr: 0.5,
              ...(option.toLowerCase() === 'low' && { color: 'info.main' }),
              ...(option.toLowerCase() === 'medium' && { color: 'warning.main' }),
              ...(option.toLowerCase() === 'high' && { color: 'error.main' }),
            }}
          />
